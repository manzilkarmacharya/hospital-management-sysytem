...
void WelcomeScreen(void) //function for welcome screen
{
	...
	printf("\n\n\n\n\n\n\n\t\t\t\t#########################################");
	printf("\n\t\t\t\t#\t\t WELCOME TO\t\t#");
	printf("\n\t\t\t\t#   NEWA HOSPITAL MANAGEMENT SYSTEM     #");
	printf("\n\t\t\t\t#########################################");
...
char Username[15];
char Password[15];
char original_Username[25]="user";
char original_Password[15]="pass";
...
void Add_rec(void)
{
	...
	ek=fopen("Record2.txt","a");//open file in write mode
	printf("\n\n\t\t\t!!!!!!!!!!!!!! Add Patients Record !!!!!!!!!!!!!\n");
...
/* ********************************************** Prescribed Doctor **************************************** */	
    ...
    if(strlen(p.Doctor)>55||strlen(p.Doctor)<3)
	{
